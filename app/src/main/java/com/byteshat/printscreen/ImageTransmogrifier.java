...
public class ImageTransmogrifier implements ImageReader.OnImageAvailableListener {
    ...
    ImageTransmogrifier(BackgroundService svc, String fileName) {
        this.svc = svc;
        this.fileName = fileName;
        Log.i("TAG", "Service " + String.valueOf(svc == null));
        Log.i("TAG", "Service " + String.valueOf(svc.getWindowManager() == null));
